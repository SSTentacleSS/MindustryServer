...
public class Pipe<A> {
    ...
    public <R, B, C> Pipe<R> pipe(TriFunction<A, B, C, R> func, B argObject1, C argObject2)
    {
        return new Pipe<R>(func.apply(object, argObject1, argObject2));
    }

    public <R, B, C, D> Pipe<R> pipe(QuadriFunction<A, B, C, D, R> func, B argObject1, C argObject2, D argObject3)
    {
        return new Pipe<R>(func.apply(object, argObject1, argObject2, argObject3));
    }
