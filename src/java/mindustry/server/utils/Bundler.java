...
public class Bundler {
	...
	public static String getLocalized(Player player, String key, Object... formatObjects) {
		return getLocalized(new Locale(player.locale), key, formatObjects);
	}

	public static String getLocalized(Player player, Locale locale, String key) {
		return getLocalized(new Locale(player.locale), key);
	}

	public static String getLocalized(Locale locale, String key, Object... formatObjects) {
